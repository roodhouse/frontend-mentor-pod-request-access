  ...
  return (
    <div className="App">
      ...
      <div id='container' className='h-screen'>
        ...
        <div id='wrapper' className='h-full pt-[62px] px-6 pb-[94px] relative md:pt-[50px] md:pl-[30px] md:pr-[94px] md:bg-darkBlue md:flex md:flex-col md:h-[initial] md:pb-0 xl:pt-[102px] xl:pl-[165px] xl:h-screen'>
          ...
          <div id='icons' className='flex justify-evenly items-center mb-[51px] md:order-4 md:bg-darkBlue md:z-20 md:mb-0 md:pb-[153px] xl:w-[723px] xl:justify-start xl:pb-[130px]'>
            <Icons />
          </div>
          <div id='form' className='md:order-3 md:pb-[64px] md:bg-darkBlue md:z-20 md:pr-[302px] xl:w-[723px] xl:pr-[301px]'>
            <Form />
          </div>
          <div id='footer' className='hidden md:block md:bg-darkBlue md:order-5 xl:absolute xl:right-0 xl:bottom-[125px] xl:z-40 xl:bg-transparent'>
            <Footer />
          </div>
        </div>
      </div>
