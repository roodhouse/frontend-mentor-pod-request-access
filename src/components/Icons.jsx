...
function Icons() {
  return (
    <>
        <div id="spotify">
            <img src={Spotify} alt="Spotify" className='w-[56px] h-[17px] md:w-[96px] md:h-[29px]'/>
        </div>
        <div id="apple">
            <img src={Apple} alt="Apple" className='w-[45px] h-[17px] md:w-[78px] md:h-[29px]' />
        </div>
        <div id="google">
            <img src={Google} alt="Google" className='w-[73px] h-[11px] md:w-[125px] md:h-[18px]' />
        </div>
        <div id="pocket">
