    ...
    <>
        <form className='flex flex-col justify-center items-center'>
            <div id='email' className='mb-4 w-full'>
                <input id='inputEmail' type="email" placeholder='Email address' className='bg-medBlue rounded-[28px] w-full decoration-white/[.50] font-["Chivo"] text-sm leading-[28px] pl-8 py-2' />
            </div>
